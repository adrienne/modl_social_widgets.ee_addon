...
* Docs - https://dev.twitter.com/docs/tweet-button
...
* Docs - https://developers.facebook.com/docs/reference/plugins/like/
...
* Docs - https://developer.linkedin.com/plugins/share-button
